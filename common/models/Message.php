...
class Message extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['text', 'entities', 'audio', 'document', 'photo', 'sticker', 'video', 'voice', 'video_note', 'contact', 'location', 'venue', 'caption', 'new_chat_members', 'new_chat_photo', 'pinned_message'], 'string'],
